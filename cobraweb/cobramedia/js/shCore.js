...
dp.sh.curLineId = null;
dp.sh.GoTo = function(lineIndex) {
	if(this.curLineId) {
		var curLine = document.getElementById(this.curLineId);
		curLine.className = 'alt';
	}
	
	var lineId = 'line_' + lineIndex;
	var line = document.getElementById(lineId);
	line.className = 'focus';
	this.curLineId = lineId;
}
